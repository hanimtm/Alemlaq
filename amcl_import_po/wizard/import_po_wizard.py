                    ...
                    for row in range(sheet.nrows):
                        try:
                            ...
                            if created_po:
                                ...
                                search_product = product_product_obj.search([('default_code', '=',sheet.cell(row, 3).value or " ")])
                                if not search_product:
                                    search_product = product_product_obj.search(
                                        [('barcode', '=', sheet.cell(row, 3).value or " ")])
                                ...
                                if not search_product:
                                    search_product = self.env['product.product'].sudo().create({
                                        ...
                                        'barcode': sheet.cell(row, 3).value,
                                ...
                                if not search_product.barcode:
                                    search_product.barcode = search_product.default_code or " "
